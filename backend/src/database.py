...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://username:password@localhost/book_agent_db")
...
if DATABASE_URL.startswith("postgresql://"):
    ...
    DATABASE_URL = f"postgresql://{username}:{password_quoted}@{hostname}{port}/{database}"
